...
public class Websocket {
	...
	public Websocket(String str, ArrayList<String> listarray2,ArrayList<String> listarray3, HashMap<String, SocketChannel> websocketlist,ArrayList<String> dbdata) {
